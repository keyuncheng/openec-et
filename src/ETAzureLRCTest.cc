...
void usage() {
    printf("usage: ./ETAzureLRC n k w pktbytes failed_ids\n");
}
...
int main(int argc, char** argv) {
    ...
    string ecid = "ETAzureLRC_" + string(argv[1]) + "_" + string(argv[2]) + "_" + string(argv[3]);
    ...
    cout << endl;
    cout << "begin ecdag decode" << endl;
    ECDAG* decdag = ec1->Decode(availsymbols, failsymbols);
    cout << "finish ecdag decode" << endl;
