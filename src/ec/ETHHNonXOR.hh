...
#ifndef __ET_HH_NON_XOR_HH__
#define __ET_HH_NON_XOR_HH__
...
class ETHHNonXOR : public ECBase
{
private:
    ...
    vector<HHNonXOR *> _instances; // base RS code instances
...
public:
    ETHHNonXOR(int n, int k, int w, int opt, vector<string> param);
    ~ETHHNonXOR();
