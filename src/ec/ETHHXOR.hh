...
#ifndef __ET_HH_XOR_HH__
#define __ET_HH_XOR_HH__
...
private:
    ...
    vector<HHXOR *> _instances; // base RS code instances
...
public:
    ETHHXOR(int n, int k, int w, int opt, vector<string> param);
    ~ETHHXOR();
