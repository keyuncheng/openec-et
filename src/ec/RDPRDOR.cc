...
RDPRDOR::RDPRDOR(int n, int k, int w, int opt, vector<string> param) {
    _n = n;
    _k = k;
    _w = w;
    _opt = opt;
...
void RDPRDOR::Place(vector<vector<int>>& group) {

}

vector<vector<int>> RDPRDOR::GetLayout() {
    int symbol_id = 0;
...
vector<int> RDPRDOR::GetNodeSymbols(int nodeid) {
